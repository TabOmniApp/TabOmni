              ...
              <DropdownMenuSub key={entry.value}>
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-1.5">
                    ...
                    {entry.isNew && (
                      <span className="rounded border border-muted-foreground/40 px-1 py-[0.5px] text-[9px] font-semibold uppercase leading-tight text-muted-foreground tracking-tight">
                        NEW
                      </span>
                    )}
                  </div>
                  ...
                  {entry.isFavorite && (!isSelected || !effort) && (
                    <Star className="size-3.5 text-muted-foreground/70 shrink-0" />
                  )}
                </DropdownMenuSubTrigger>
