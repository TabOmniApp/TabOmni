...
export function NoteList() {
  ...
  // Which folders are shut lives in the store rather than here, for the reason
  // its comment gives: `select` has to be able to open one.
  const toggleCollapsed = useNotes((state) => state.toggleFolder)
