...
export function RequestList() {
  ...
  const collapsed = useApi((state) => state.collapsed)
  ...
  // Which folders are shut lives in the store rather than here: `select` has
  // to be able to open one, and what lands in the pane is regularly picked
  // somewhere else — the tab strip, the search palette.
  const toggleCollapsed = useApi((state) => state.toggleFolder)
