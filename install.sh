#!/usr/bin/env bash
#
# Installs Tabula into /Applications from a GitHub release.
#
...
if [ "$MACOS_MAJOR" -lt 12 ]; then
  echo "Tabula needs macOS 12 (Monterey) or newer." >&2
...
# and the pty daemon it spawned holds a socket in ~/.tabula that a new
